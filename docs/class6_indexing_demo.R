...
x0 <- x[0] # give you a vector with length 0
x0
x11 <- x[11] # give you an NA instead of an error.
x11
...
n <- list(1:3, c('John', 'Chris', 'Rachel'),
          c(T, T, T), c(98.3, 98.5, 99))
n
n1 <- n[1] # every time it will give back a list
n1
typeof(n1)
n[-1]
n[1:2]
...
df[1][[1]]
df[1][[1]] <- c(99, 999, 9999) # change values
df
df['id'][[1]]
df[[1]]
