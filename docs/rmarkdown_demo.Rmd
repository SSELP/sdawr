---
title: 'Class 2: R markdown demo'
author: 
- Lei Song^1^, Author Two^2^
- ^1^ Rutgers Unversity, ^2^ Xxx University
date: "`r Sys.time()`"
output: 
  html_document:
    toc: true
...
### Image
Insert an image using ![](figures/R_Rutgers.jpg)

or we could use code chunk to insert:

```{r, out.width = "20%", echo=FALSE, fig.align='center'}
knitr::include_graphics("figures/R_Rutgers.jpg")
```
