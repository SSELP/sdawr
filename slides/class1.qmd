...
#| 
# Load libraries
# install.packages(c("sf", "terra", "viridis", "rnaturalearth"))
library(terra)
library(viridis)
...
- **Office hours**:
    - Lei Song: Wed, 1:50 - 3:50PM (or by appointment)
    - Md Arafat Hassan (Your TA): Mon 2:30PM - 3:30PM
    - To streamline the process, please use the shared Google Sheet to schedule your appointment.
...
- **Course approach**
    - The order of the lecture might be occasionally non-linear, particularly the first two weeks.
...
- Open RStudio, copy these lines into the Console
...
- Replace "COL" with the country [code](https://eapis.cbp.dhs.gov/eapis-enroll/countryCodes.do) you are interested in.
- and hit Enter/Return!
- Share a screenshot of your map in our Google Chat!
...
- (Optional) Set up your personal access token following section 2.1 in [Git/GitHub](https://sselp.github.io/sdawr/git-github.html)).
