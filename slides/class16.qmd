...
- Change the values of population to population / 1000.
- Save it to your class note folder with name "population_k_2020.tif".
...
pop_global <- pop_global / 1000

writeRaster(pop_global, "your_classnote_folder/population_k_2020.tif")
```
