...
knitr::include_graphics("fig/u1m2-1.jpg") 
```
...
Moving on, Family maps onto `R` structures, and Species onto types, primarily to data types. My organization of these topics is pieced together from several sources of information that are online (classes [1](http://adv-r.had.co.nz/OO-essentials.html), [2](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#Object_002doriented-programming); structures [3](http://adv-r.had.co.nz/Data-structures.html), [4](https://rspatial.org/intr/3-basic-data-structures.html); types: [5](https://rspatial.org/intr/2-basic-data-types.html)), and it is based on the level of complexity inherent in the object.
...
all_ns <- loadedNamespaces()

# Try to unload everything that isn't a core base package
base_pkgs <- c("base", "methods", "utils", "stats", "graphics", "grDevices", "datasets")
to_unload <- setdiff(all_ns, base_pkgs)
