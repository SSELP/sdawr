...
2. When asked to report the result of calculations in the vignette text (e.g. in Task 10), you can use another RMarkdown trick, which is to let the calculation be done by code inserted between a single pair of backticks, with the first backtick followed immediately by r and a space. See [here](https://rmarkdown.rstudio.com/lesson-4.html) for more explanation of that. 
...
include_graphics("fig/u2m1_a4.png") 
```

5. Your submission should be on a new side branch "a4".
