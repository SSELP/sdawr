...
5. From Chunk 43, recreate `species_alb`, and use the code in #2a to recreate buffers of 30 km width around the 5 randomly selected species points, and plot those. Recreate the buffers, but use `sample_n` to do the random draw. Plot those and compare the difference.  
